...
const Step3 = ({ formData, handleChange, handleSubmit, handleBack }) => {
    return (
        <div className="flex justify-between h-screen font-sans">
            ...
            <div className="flex-1 flex justify-center items-center p-5 bg-white rounded-r-lg">
                <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-xl">
                    <h2 className="text-center text-2xl text-purple-800 mb-5">Hackathon Details</h2>

                    <div className="mb-5">
                        <label htmlFor="hackathonName" className="block text-sm font-semibold text-gray-700 mb-2">Hackathon Name</label>
                        <input
                            type="text"
                            id="hackathonName"
                            name="hackathonName"
                        ...
                        <div className="flex items-center space-x-6">
                            <label htmlFor="online" className="flex items-center space-x-2">
                                <input
                                    type="radio"
                                    id="online"
                                    name="natureOfHackathon"
                                    value={true}
                                    checked={formData.natureOfHackathon === true}
                                    onChange={handleChange}
                                    className="text-purple-500 focus:ring-2 focus:ring-purple-500"
                                />
                                <span>Online</span>
                            </label>
                            <label htmlFor="offline" className="flex items-center space-x-2">
                                <input
                                    type="radio"
                                    id="offline"
                                    name="natureOfHackathon"
                                    value={false}
                                    checked={formData.natureOfHackathon === false}
                                    onChange={handleChange}
                                    className="text-purple-500 focus:ring-2 focus:ring-purple-500"
                                />
                                <span>Offline</span>
                    ...
                    <div className="mb-5">
                        <label htmlFor="brief" className="block text-sm font-semibold text-gray-700 mb-2">Brief Description</label>
                        <textarea
                            id="brief"
                            name="brief"
                    ...
                    <div className="mb-5">
                        <label htmlFor="expectedRegistrations" className="block text-sm font-semibold text-gray-700 mb-2">Expected Registrations</label>
                        <input
                            type="number"
                    ...
                    <div className="mb-5">
                        <label htmlFor="teamSizeRange" className="block text-sm font-semibold text-gray-700 mb-2">Team Size Range</label>
                        <input
                            type="text"
                            id="teamSizeRange"
                            name="teamSizeRange"
