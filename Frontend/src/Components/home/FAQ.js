            ...
            <div className="bg-white rounded-lg  ">
              <div className=" divide-gray-200 ">
                {faqData.map((item) => (
                  <div
                    key={item.id}
                    className="border-b border-gray-200 rounded last:border-b-1 mb-8 shadow-xl hover:shadow-lg hover:shadow-purple-300 hover:rounded-lg hover:bg-white transform hover:scale-125 transition-all duration-300"
                  >
                    <button
